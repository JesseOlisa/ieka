<?php
    ...
    $sdl = "SELECT * FROM transactions WHERE farm_id = {$result['farm_id']} ORDER BY id DESC LIMIT $offset, $limit";
                ...
                <table>
                    ...
                    <?php
                        ...
                        while($transactions = $fetch->fetch_assoc()):
                            $sql = "SELECT * FROM customers WHERE id = '{$transactions['customer_id']}' LIMIT 1";
