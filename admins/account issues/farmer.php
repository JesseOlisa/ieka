<?php
    ...
    $scl = "SELECT * FROM farmer_account_issues";
    ...
    $sdl = "SELECT * FROM farmer_account_issues ORDER BY id DESC LIMIT $offset, $limit";
...
<html>
    <head>
        <title>All farmer complaints on IEKA</title>
    ...
    <body>
        ...
        <div class="main_information">
            ...
            <section class="main_section">
                ...
                <div class="headnote">
                    <h6>All farmer complaints on IEKA</h6>
                    <hr id="under">
                </div>
                ...
                <div class="all_complaints">
                    ...
                    <table>
                        ...
                        <?php
                            $number = 1;
                            while($farmer_complaints = $fetch->fetch_assoc()):
                        ?>    
                                <td><?=$number++;?></td>
                                <td><?=$farmer_complaints['customer_name'];?></td>
                                <td><?=$farmer_complaints['account_issue'];?></td>
                            </tr>
                        <?php
                            endwhile;
                        ?>
