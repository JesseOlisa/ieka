...
<html>
    ...
    <body>
        ...
        <div class="form-body">
            <form action="customer_login.php" id="login" method="POST">
                ...
                <div>
                    <input type="submit" value="Sign in" name="cus_login" id="cus_login">
                </div>
                <div class="new_account">
                    <p>New to Ieka?<a href="customer-signup.php"> Create a new account with us</a></p>
                </div>
            </form>
        </div>
    </body>
